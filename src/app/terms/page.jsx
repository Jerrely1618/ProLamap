      ...
      <div className="flex-grow p-5 overflow-auto">
        ...
        <section className="mb-4">
          ...
          <p>
            ...
            graphics, logos, designs, and user interfaces (the "Content"), are
            the intellectual property of ProlaDict and are protected by
        ...
        <section className="mb-4">
          ...
          <p>
            ...
            accuracy, reliability, or completeness of the Content. We disclaim
