  ...
  return (
    <div className="terms-of-use-container">
      ...
      <section>
        ...
        <p>
          By accessing or using ProlaDict (the "Website"), you agree to comply
          with and be bound by these Terms of Use (the "Terms"). If you do not
      ...
      <section>
        ...
        <p>
          ...
          graphics, logos, designs, and user interfaces (the "Content"), are the
          intellectual property of ProlaDict and are protected by copyright,
        ...
        <p>
          ...
          and use the Website for personal, non-commercial purposes only. This
          license does not grant you any rights to modify, reproduce,
          distribute, or create derivative works from any Content without
          express written permission from ProlaDict.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Using the Website to infringe on the intellectual property rights of
            others;
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          ...
          rights have been infringed, please contact us through the contact form
          available on the Website. We will investigate the matter and take
          appropriate action, which may include removing the infringing content.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          available" basis. ProlaDict makes no warranties, express or implied,
          regarding the operation or availability of the Website or the
          accuracy, reliability, or completeness of the Content. We disclaim all
      ...
      <section>
        ...
        <p>
          To the fullest extent permitted by law, ProlaDict shall not be liable
      ...
      <section>
        ...
        <p>
          ...
          of NY, United States of America. Any disputes arising under these
